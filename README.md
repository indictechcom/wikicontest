...
The easiest way to run WikiContest locally is using Docker Compose with hot-reload for all services.
...
For more detailed Docker documentation, see [`docs/DOCKER_DEVELOPMENT.md`](docs/DOCKER_DEVELOPMENT.md).
